...
public class eCommerce_TC5_withDataprovider extends AppiumBaseTest{
	...
	public Object[][] getData() throws IOException
	{
		...
		return new Object[][] {{"Surya Krishnan","female","Argentina"},{"Surya Pran","male","Japan"}}; //to get data direct  from array
